...
// sources:
// pkg/server/storage/migrations/sql/001_add-initial-tables.down.sql
// pkg/server/storage/migrations/sql/001_add-initial-tables.up.sql
// DO NOT EDIT!
...
func _001_addInitialTablesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "001_add-initial-tables.up.sql", size: 337, mode: os.FileMode(420), modTime: time.Unix(1519186410, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
